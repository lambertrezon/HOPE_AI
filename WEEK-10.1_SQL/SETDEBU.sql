...
SELECT customer_id,amount FROM sales WHERE amount > 5000;
-- To improve performance can create index on the amount column in sales table 
CREATE INDEX idx_amt ON sales(amount);
SELECT customer_id,amount FROM sales WHERE amount > 5000;
-- Data Type Mismatch
